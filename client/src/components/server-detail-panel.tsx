...
export function ServerDetailPanel({ server, onClose, onJoin }: ServerDetailPanelProps) {
  const { isFavorite, addFavorite, removeFavorite, isWatchlisted, addToWatchlist, removeFromWatchlist } = useFavoritesContext();
  ...
  return (
    <aside 
      className="fixed top-[100px] right-0 w-[480px] h-[calc(100vh-100px)] bg-card border-l border-border overflow-y-auto z-30 animate-slide-in"
      onWheel={(e) => e.stopPropagation()}
      onScroll={(e) => e.stopPropagation()}
    >
      <div className="sticky top-0 bg-card border-b border-border p-4 z-10 backdrop-blur-sm">
