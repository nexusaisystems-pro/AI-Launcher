...
export default function Downloads() {
  ...
  const downloads = {
    windows: {
      ...
      icon: Laptop,
      color: 'text-blue-500',
      url: `https://github.com/${GITHUB_REPO}/releases/latest/download/GameHub-Launcher.exe`,
      fileSize: '~160MB',
    ...
    mac: {
      ...
      icon: Apple,
      color: 'text-gray-400',
      url: `https://github.com/${GITHUB_REPO}/releases/latest/download/GameHub-Launcher.dmg`,
      fileSize: '~165MB',
    ...
    linux: {
      ...
      url: `https://github.com/${GITHUB_REPO}/releases/latest/download/GameHub-Launcher.AppImage`,
      fileSize: '~155MB',
