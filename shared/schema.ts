...
export const servers = pgTable("servers", {
  ...
  modList: jsonb("mod_list").$type<EnrichedMod[]>().default([]), // Full mod list with Workshop data
  ...
  // Sponsored server fields for monetization
  isSponsored: boolean("is_sponsored").default(false),
  sponsorPriority: integer("sponsor_priority").default(0), // Higher = shows first
  sponsorExpiresAt: timestamp("sponsor_expires_at"), // Sponsorship expiration
});
